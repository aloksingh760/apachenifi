...
public class MiraiTransformationSingleRecordMysql extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            jsonString = parseJsonSigleRecord(inputJson,sensorMap);
    ...
    public String	parseJsonV1(JsonElement jsonstring, HashMap<String, String> sensorMap2){
    	...
    	String transformedJson1=null;
			...
			//	MiraiBean miraiob=new MiraiBean();
	    	   ...
	    	   transformedJson1= transformedJson1.replaceAll("\\\\", "").replaceAll("(\"\\{\")","\\{\"").replaceAll("(\"\\}\")","\"\\}").replaceAll("\\}\"", "\\}");
    ...
    public String	parseJsonSigleRecord(JsonElement jsonstring, HashMap<String, String> sensorMap2){
			...
			try {
		       ...
		       for (JsonElement jsonElement : elemArr) {
		    	   ...
		    	   if(sensorName.equals(sensorMap2.get("limit_switch_unit_1_valve_1"))) {
		    		   ...
		    		   if(jb.get("Value").getAsInt()==1) {
		    		   miraiob.setLimit_switch_unit_1_valve_1("Open");
		    		   }else {
		    			   miraiob.setLimit_switch_unit_1_valve_1("Close");
		    		   }
		    	   }else if(sensorName.equals(sensorMap2.get("limit_switch_unit_1_valve_2"))) {
		    		   
		    		   if(jb.get("Value").getAsInt()==1) {
			    		   miraiob.setLimit_switch_unit_1_valve_2("Open");
			    		   }else {
			    			   miraiob.setLimit_switch_unit_1_valve_2("Close");
			    		   }
		    	   }else if(sensorName.equals(sensorMap2.get("limit_switch_unit_2_valve_1"))) {
		    		   if(jb.get("Value").getAsInt()==1) {
			    		   miraiob.setLimit_switch_unit_2_valve_1("Open");
			    		   }else {
			    			   miraiob.setLimit_switch_unit_2_valve_1("Close");
			    		   }
		    	   }else if(sensorName.equals(sensorMap2.get("limit_switch_unit_2_valve_2"))) {
		    		   if(jb.get("Value").getAsInt()==1) {
			    		   miraiob.setLimit_switch_unit_2_valve_2("Open");
			    		   }else {
			    			   miraiob.setLimit_switch_unit_2_valve_2("Close");
			    		   }
		    	   }else if(sensorName.equals(sensorMap2.get("motor_temp_unit_1"))) {
		    		   miraiob.setMotor_temp_unit_1(jb.get("Value").getAsFloat()/10);
		    	   }else if(sensorName.equals(sensorMap2.get("pump_temp_unit_1"))) {
		    		   miraiob.setPump_temp_unit_1(jb.get("Value").getAsFloat()/10);
		    	   }else if(sensorName.equals(sensorMap2.get("motor_temp_unit_2"))) {
		    		   miraiob.setMotor_temp_unit_2(jb.get("Value").getAsFloat()/10);
		    	   }else if(sensorName.equals(sensorMap2.get("pump_temp_unit_2"))) {
		    		   miraiob.setPump_temp_unit_2(jb.get("Value").getAsFloat()/10);
		    	   }else if(sensorName.equals(sensorMap2.get("motor_vibration_unit_1"))) {
		    		   miraiob.setMotor_vibration_unit_1(jb.get("Value").getAsFloat()/100);
		    	   }else if(sensorName.equals(sensorMap2.get("pump_vibration_unit_1"))) {
		    		   miraiob.setPump_vibration_unit_1(jb.get("Value").getAsFloat()/100);
		    		   ...
		    		   miraiob.setInlet_pressure_unit_1(jb.get("Value").getAsFloat()/10);
		    	   }else if(sensorName.equals(sensorMap2.get("pump_pressure_unit_1"))) {
		    		   miraiob.setOutlet_pressure_unit_1(jb.get("Value").getAsFloat()/10);
		    	   }else if(sensorName.equals(sensorMap2.get("motor_pressure_unit_2"))) {
		    		   miraiob.setInlet_pressure_unit_2(jb.get("Value").getAsFloat()/10);
		    	   }else if(sensorName.equals(sensorMap2.get("pump_pressure_unit_2"))) {
		    		   miraiob.setOutlet_pressure_unit_2(jb.get("Value").getAsFloat()/10);
		    	   }
		    		   ...
		    		   miraiob.setPower_unit_2(jb.get("Value").getAsFloat());
		    	   }
