...
public class MiraiJsonScheamaProcessor extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            jsonString = parseJsonV1(inputJson,sensorMap);
			...
			//	MiraiBean miraiob=new MiraiBean();
		       ...
		       for (JsonElement jsonElement : elemArr) {
		    	   ...
		    	   if(sensorName.equals(sensorMap2.get("limit_switch_unit_1_valve_1"))) {
		    		   ...
		    		   }else if(jb.get("Value").getAsInt()==0){
		    			   miraicolumns.setSwitch_level("Close");	   
		    		   }
		    	   }else if(sensorName.equals(sensorMap2.get("limit_switch_unit_1_valve_2"))) {
		    		   miraicolumns.setMeasurunit_symbol("Boolean");
		    		   miraicolumns.setUnit_id(1);
	    	   ...
	    	   transformedJson1= transformedJson1.replaceAll("\\\\", "").replaceAll("(\"\\{\")","\\{\"").replaceAll("(\"\\}\")","\"\\}").replaceAll("\\}\"", "\\}").replaceAll("\\},", "\\}\n").replaceAll("[\\[\\]]","");
	    	   
	    	  // transformedJson1.replaceAll("\\},", "\\},\n");
